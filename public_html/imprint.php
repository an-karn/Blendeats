            ...
            <div class="footer-details">
                ...
                <div class="footer-contact">
                    ...
                    <div class="social-contact">
                        ...
                        <a href="https://facebook.com" class="sicon facebook" title="Facebook"><svg
                                viewBox="0 0 512 512">
                                <path fill="white"
                        ...
                        <a href="https://instagram.com" class="icon-15 instagram" title="Instagram"><svg
                                viewBox="0 0 512 512">
                                <g>
                                    <path fill="white"
                        ...
                        <a href="mailto:igiri@jacobs-university.de" class="icon-8 email" title="Email"><svg
                                viewBox="0 0 512 512">
                                <path fill="white"
                        ...
                        <a href="https://linkedin.com" class="icon-17 linkedin" title="LinkedIn"><svg
                                viewBox="0 0 512 512">
                                <path fill="white"
